...
const UpdateCompanyForm = ({company,setOpenUpdateCompany}:UpdateCompanyForm) => {
  ...
  return (
    <form onSubmit={form.onSubmit((values) => mutate(values))} className='flex flex-col gap-4 w-1/3 mx-auto container sectionPadding shadow-lg p-4 bg-[#ebecf4]'>
    ...
    />
    {
      ...
      <button className="text-white hover:text-[#1c3383] p-1 rounded-md bg-[#1c3383] hover:bg-[gray] " type="submit"><Translate text="update"/></button>
